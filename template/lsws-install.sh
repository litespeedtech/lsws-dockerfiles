...
help_message(){
    ...
    echo "${EPACE}${EPACE}Example: bash lsws_install.sh --lsws 6.3.5"
    echow '--arch'
    echo "${EPACE}${EPACE}Example: build.sh --lsws 6.3.5 --arch [x86_64|aarch64], will build image for amd64 or arm64"
    exit 0
}
